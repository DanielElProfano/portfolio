        ...
        <div>
            <section className="b-about__section">
                <div className="b-about__title">
                    ...
                    <div className="b-about__img">
                        ...
                        {/* <div className="b-about__circle"> </div> */}
                </div>
            </section>
            <section className="b-about__section b-about__section--2">
                ...
                <div className="b-about__title b-about__title--2">
                    ...
                    <h1 className="b-about__h1 b-about__h1--red">Front</h1>
                    <div  className="b-about__comentarios">
                        <p className="b-about__text b-about__text--big b-about__text--red">React</p>
                        <p className="b-about__text b-about__text--big b-about__text--red">Angular</p>
                    </div>  
                    <h1 className="b-about__h1 b-about__h1--red">Back</h1>
                    <div  className="b-about__comentarios">
                        <p className="b-about__text b-about__text--big b-about__text--red">Node JS</p>
                        <p className="b-about__text b-about__text--big b-about__text--red">PHP</p>
                    </div>  
                </div>           
        </section>
